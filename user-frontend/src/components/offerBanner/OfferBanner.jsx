        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center p-4">
              ...
              <button className="px-4 py-2 md:px-6 md:py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-medium rounded-full transition-transform transform hover:scale-105 shadow-lg">
                Buy Now
              </button>
            </div>
          </div>
...
<p className="text-white text-base md:text-lg mb-4">Personalize your space with our exclusive customization options tailored to your style!</p>
          ...
          <button className="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-semibold rounded-full transition-transform transform hover:scale-105 shadow-lg">
            Buy Now
          </button>
        </div>
      </div>
